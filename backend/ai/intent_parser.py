...
典型场景：
- 单次往返（"6/10出发，7/10返回"，1条航线）→ task_type="single", date_start="2026-06-10", date_end="2026-06-10", return_date_start="2026-07-10"（单航线搜索有完整往返UI）
- 多次往返（"6/10或6/17出发，7/10或7/17返回"）→ task_type="batch", specific_dates=["2026-06-10","2026-06-17"], return_dates=["2026-07-10","2026-07-17"]
